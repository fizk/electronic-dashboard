    ...
    return (
        <Tab>
            ...
            <TabItem title="Lists" path="lists">
                <dl className="eseries__definition-list">
                    <dt className="eseries__definition-term">E3 values</dt>
                    <dd className="eseries__definition-sub-term">(40% tolerance)</dd>
                    <dd>1.0, 2.2, 4.7</dd>

                    <dt className="eseries__definition-term">E6 values</dt>
                    <dd className="eseries__definition-sub-term">(20% tolerance)</dd>
                    <dd>1.0, 1.5, 2.2, 3.3, 4.7, 6.8</dd>

                    <dt className="eseries__definition-term">E12 values</dt>
                    <dd className="eseries__definition-sub-term">(10% tolerance)</dd>
                    <dd>1.0, 1.2, 1.5, 1.8, 2.2, 2.7, 3.3, 3.9, 4.7, 5.6, 6.8, 8.2</dd>

                    <dt className="eseries__definition-term">E24 values</dt>
                    <dd className="eseries__definition-sub-term">(5% tolerance)</dd>
                    <dd>1.0, 1.1, 1.2, 1.3, 1.5, 1.6, 1.8, 2.0, 2.2, 2.4, 2.7, 3.0, 3.3, 3.6, 3.9, 4.3, 4.7, 5.1, 5.6, 6.2, 6.8, 7.5, 8.2, 9.1</dd>

                    <dt className="eseries__definition-term">E48 values</dt>
                    <dd className="eseries__definition-sub-term">(2% tolerance)</dd>
                    ...
                    <dt className="eseries__definition-term">E96 values</dt>
                    <dd className="eseries__definition-sub-term">(1% tolerance)</dd>
                    ...
                    <dt className="eseries__definition-term">E192 values</dt>
                    <dd className="eseries__definition-sub-term">(0.5% and lower tolerance)</dd>
