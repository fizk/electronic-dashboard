...
export default function InvertingOpAmp ({}: Props) {
                                            //     v   rf   r2
    ...
    return (
        <>
            <section className="inverting-op-amp__input">
                <Section variant={['framed', 'raised']}>
                    <FormStack>
                        <FormRow variants={['stretch']}>
                            <LabelInput text={<>V<sub>in</sub></>} 
                                type="number"
                                onChange={handleVin} value={inputState.at(0)} />
                        </FormRow>
                        <FormRow variants={['stretch']}>
            ...
            <section className="inverting-op-amp__schema">
            ...
            <section className="inverting-op-amp__formula">
                <p>
            ...
            <section className="inverting-op-amp__description">
                <p>
